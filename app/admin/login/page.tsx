...
export default function AdminLoginPage() {
  ...
  return (
    <div className="relative isolate overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(251,191,36,0.18),_transparent_35%),radial-gradient(circle_at_bottom_right,_rgba(255,255,255,0.08),_transparent_30%)]" />
      <div className="mx-auto flex min-h-[calc(100vh-9rem)] w-full max-w-5xl items-center px-6 py-16">
        <div className="grid w-full gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          <section className="flex flex-col justify-center gap-6">
            ...
            <h1 className="max-w-xl text-5xl font-semibold leading-none text-white">
              Internal tools for shipping ads, faster.
            </h1>
            <p className="max-w-lg text-base leading-7 text-zinc-300">
              This admin area is where campaign assets, prompt experiments, and
              product-specific advert generations will live. Start by unlocking
              the advert maker.
            </p>
            {!isConfigured ? (
